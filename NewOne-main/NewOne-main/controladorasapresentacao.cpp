...
{
    char texto[]="Servico descadastrar usuario nao implementado. Digite algo.";             // Mensagem a ser apresentada.
    CLR_SCR;                                                                                    // Limpa janela.
    cout << texto << endl;                                                      // Imprime nome do campo.
    getch();
}
...
void CntrApresentacaoHospedagem::cadastrarHospedagem(Email email)
{
    ...
    hospedagem.setDescricao_hosp(descricao);
...
void CntrApresentacaoAvaliacao::cadastrarAvaliacao(Email email)
{
    ...
    avaliacao.setCodigo_ava(codigo);
    avaliacao.setNota_ava(nota);
    avaliacao.setDescricao_ava(descricao);
...
{
    char texto[]="Servico editar avaliacao nao implementado. Digite algo.";             // Mensagem a ser apresentada.
    CLR_SCR;                                                                                    // Limpa janela.
    cout << texto << endl;                                                      // Imprime nome do campo.
    getch();
}
...
{
    char texto[]="Servico descadastrar avaliacao nao implementado. Digite algo.";             // Mensagem a ser apresentada.
    CLR_SCR;                                                                                    // Limpa janela.
    cout << texto << endl;                                                      // Imprime nome do campo.
    getch();
}
